...
class VariantSelects extends HTMLElement {
  ...
  // Custom code to filter product media when switching variants
  filterMedia() {
    document.querySelectorAll('.thumbnail-list__item[data-thumbnailcolor]').forEach( el => el.style.display = "none");
    document.querySelectorAll('.product__media-item[data-thumbnailcolor]').forEach( el => el.classList.add("mob-hide"));
    
    var selected_variant = this.currentVariant.featured_media.alt;
    var selected_attribute_thumb = '.thumbnail-list__item[data-thumbnailcolor="' + selected_variant + '"]';
    var selected_attribute_media = '.product__media-item[data-thumbnailcolor="' + selected_variant + '"]';
    console.log(document.querySelectorAll(selected_attribute_media));
    
    if (selected_variant == selected_variant) {
      document.querySelectorAll(selected_attribute_thumb).forEach(el => el.style.display = "initial");
      document.querySelectorAll(selected_attribute_media).forEach(el => el.classList.remove("mob-hide"));
    }
  }
